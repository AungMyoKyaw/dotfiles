...
FILES_TO_LINK=(
  ...
  "$DOTFILES_DIR/gemini/commands:$HOME/.gemini/commands"
  ...
  "$DOTFILES_DIR/vscode-insider/agents:$HOME/Library/Application Support/Code - Insiders/User/agents"
  ...
  "$DOTFILES_DIR/vscode-insider/agents:$HOME/Library/Application Support/Code/User/agents"
  ...
  "$DOTFILES_DIR/antigravity/mcp.json:$HOME/Library/Application Support/Antigravity/User/mcp.json"
  "$DOTFILES_DIR/antigravity/mcp_config.json:$HOME/.gemini/antigravity/mcp_config.json"
  ...
  "$DOTFILES_DIR/opencode/instructions.md:$HOME/.config/opencode/instructions.md"
  ...
  "$DOTFILES_DIR/copilot-cli/config.json:$HOME/.copilot/config.json"
  "$DOTFILES_DIR/copilot-cli/mcp-config.json:$HOME/.copilot/mcp-config.json"
  "$DOTFILES_DIR/copilot-cli/copilot-instructions.md:$HOME/.copilot/copilot-instructions.md"
  "$DOTFILES_DIR/copilot-cli/agents:$HOME/.copilot/agents"
