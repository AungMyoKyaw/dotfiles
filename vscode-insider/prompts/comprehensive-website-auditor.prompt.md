...
- **TAILWIND CSS:** Absolute priority—use Tailwind utility classes for ALL fixes when detected
...
10. **Persistence Protocol:** Never settle for "good enough"—only "perfect" is acceptable. Try at least 5 approaches before declaring any issue unsolvable.
    </systematic_protocol>
