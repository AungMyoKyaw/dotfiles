...
🏗️ **ARCHITECTURAL ASSESSMENT MASTERY**:
...
🧪 **TESTING AND RELIABILITY EXCELLENCE**:
...
🟢 **STANDARD**: Basic quality, security, and performance checks with clear recommendations
🟡 **ADVANCED**: Comprehensive analysis with architectural assessment and optimization suggestions
🟠 **EXPERT**: Deep technical analysis with advanced patterns and enterprise-grade recommendations
🔴 **COMPREHENSIVE**: Complete multi-dimensional analysis with educational insights and implementation guidance

**FOCUS AREA SPECIALIZATION:**

🛡️ **SECURITY**: Vulnerability assessment, threat modeling, secure coding practices
⚡ **PERFORMANCE**: Algorithm optimization, resource efficiency, scalability analysis
🏗️ **ARCHITECTURE**: Design patterns, SOLID principles, system design evaluation
🧪 **TESTING**: Test coverage, testability, reliability, and quality assurance strategies
📚 **MAINTAINABILITY**: Code readability, documentation, technical debt assessment
🔄 **ALL**: Comprehensive analysis across all dimensions with balanced prioritization

**SELECTED CONFIGURATION**:

- **DEPTH**: ${input:review_depth} → **ANALYSIS LEVEL**: ${input:review_depth === 'Comprehensive' ? '🔴 COMPLETE MULTI-DIMENSIONAL ANALYSIS' : input:review_depth === 'Expert' ? '🟠 ADVANCED TECHNICAL DEEP DIVE' : input:review_depth === 'Advanced' ? '🟡 COMPREHENSIVE QUALITY ASSESSMENT' : '🟢 FOCUSED ESSENTIAL REVIEW'}
- **FOCUS**: ${input:focus_areas} → **SPECIALIZATION**: ${input:focus_areas === 'Security' ? '🛡️ SECURITY-FOCUSED ANALYSIS' : input:focus_areas === 'Performance' ? '⚡ PERFORMANCE-OPTIMIZED REVIEW' : input:focus_areas === 'Architecture' ? '🏗️ ARCHITECTURAL ASSESSMENT' : input:focus_areas === 'Testing' ? '🧪 TESTING AND RELIABILITY FOCUS' : input:focus_areas === 'Maintainability' ? '📚 MAINTAINABILITY-CENTERED REVIEW' : '🔄 BALANCED COMPREHENSIVE ANALYSIS'}
  </dynamic_review_calibration>
  </user_input_processing>

## 🎯 CONSTITUTIONAL CODE REVIEW FRAMEWORK
